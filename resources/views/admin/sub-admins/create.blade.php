...
@section('title', __('admin.create_sub_admin'))
@section('page_title', __('admin.create_sub_admin'))
...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.sub-admins.store') }}" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 sm:p-8">
        @csrf
        ...
        <div class="mt-8 flex justify-end gap-3">
            ...
            <button type="submit" class="rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700 transition">{{ __('admin.create_sub_admin') }}</button>
        </div>
    </form>
@endsection
