...
@section('title', __('admin.edit_parcel_pricing'))
@section('page_title', __('admin.edit_parcel_pricing'))
...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.parcel-pricing.update', $pricing->id) }}" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 sm:p-8">
        @csrf @method('PUT')
        ...
        <div class="mt-8 flex justify-end gap-3">
            ...
            <button class="rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700 transition">{{ __('admin.update') }}</button>
        </div>
    </form>
@endsection
