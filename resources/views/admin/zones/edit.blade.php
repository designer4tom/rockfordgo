...
@section('title', __('admin.edit_zone'))
@section('page_title', __('admin.edit_zone'))
...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.zones.update', $zone->id) }}">
        ...
        <div class="mt-6 flex justify-end gap-3">
            ...
            <button class="rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700 transition">{{ __('admin.update_zone') }}</button>
        </div>
    </form>
@endsection
